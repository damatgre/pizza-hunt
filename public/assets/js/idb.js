...
request.onupgradeneeded = function(event){
    ...
    //create an object store (table) called 'new_pizza' set it to have an auto incremeneting primary key of sorts
...
request.onsuccess = function(event){
    ...
    //or simply established a connect, save a reference to db in global variable 
